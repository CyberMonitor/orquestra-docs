...
Using either the GitHub UI or by cloning your repo and using the command line, create two files: `src/python/lstm/data_manipulator.py` to generate and manipulate the input datasets, and `src/python/lstm/lstm_model.py` to build the network model:
