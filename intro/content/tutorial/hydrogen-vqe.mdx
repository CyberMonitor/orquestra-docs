...
This repository will be where you build your resource. [This GitHub repo](https://github.com/zapatacomputing/diatomic-molecule) can be used as a reference for how the `diatomic-molecule` resource should look like throughout the tutorial.
